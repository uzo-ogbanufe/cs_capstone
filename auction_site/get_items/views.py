...
from bid.views import bid_on_item

def get_items(request):
    '''
    Function to display all of the items in the database that are currently available to bid on
    '''
...
def item_detail(request, item_id):
    '''
    Displays the details of a particular item
    '''
    ...
    try:
        ...
        if request.method == 'POST':
            ...
            if bid_form.is_valid():
                ...
                return bid_on_item(request, item_id, bid_price)
        else: 
